...
public class RadioBoxesFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        nextOrFinishButton.setOnClickListener(v -> {
            ...
            {
                /* Here, You go back from where you started OR If you want to go next Activity just change the Intent*/ Intent questions = new Intent(mContext, AnswersActivity.class);
