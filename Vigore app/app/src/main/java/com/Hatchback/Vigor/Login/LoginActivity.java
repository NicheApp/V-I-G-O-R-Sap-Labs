package com.Hatchback.Vigor.Login;
...
import com.Hatchback.Vigor.FormActivity;
import com.Hatchback.Vigor.MainActivity;
import com.Hatchback.Vigor.R;
import com.Hatchback.Vigor.Register.RegisterActivity;
                                ...
                                .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()){
                                            ...
                                            Intent intent = new Intent(LoginActivity.this, FormActivity.class); // Intent to MainActivity
                                            startActivity(intent);
                                            finish();
                                        }
                                        else{
